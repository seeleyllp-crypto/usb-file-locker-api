...
- A public Recovery Decision Wizard at `/decision` with seven fixed situations, twenty-one yes-or-no decision points, twenty-eight reviewed outcomes, current-tab history, back/restart controls, and privacy-safe action-plan export
