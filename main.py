...
COMPANION_APPS = [
    ...
    {"name": "Download Verification Center", "script": "download_verification_center.py", "purpose": "Calculate SHA-256, export locally sealed receipts, inspect or compare one sanitized prior receipt, run a bounded non-recursive aggregate receipt-folder audit with a searchable, fixed-filter, deterministic-sort, clearable local-only filename review, inspect file structure, and explicitly run Defender without extracting, executing, or uploading selected files, folders, names, search text, filters, sorting, results, receipts, keys, or reports."},
