...
class VaultLinkApiTests(unittest.TestCase):
    ...
    def test_support_redactor_is_published_as_a_privacy_safe_customer_companion(self):
        self.assertEqual(api.API_VERSION, "0.55.0")
    ...
    def test_download_verification_is_published_without_file_upload_actions(self):
        ...
        self.assertIn("searchable", companion["purpose"])
        self.assertIn("fixed triage guidance", companion["purpose"])
        self.assertIn("temporary review marks", companion["purpose"])
        self.assertIn("hide-reviewed mode", companion["purpose"])
        self.assertIn("progress counts", companion["purpose"])
        self.assertIn("session reset", companion["purpose"])
        self.assertIn("failure-first navigation", companion["purpose"])
        self.assertIn("search text", companion["purpose"])
        self.assertIn("review marks", companion["purpose"])
    ...
    def test_customer_answers_are_fixed_searchable_and_collect_nothing(self):
        ...
        self.assertEqual(payload["api_version"], "0.55.0")
